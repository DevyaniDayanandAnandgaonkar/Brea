...
<div  className="tempp">
        <button id="stat-btn"
          className={activeTab === "tab1" ? "active" : "notActiveMe"} 
          onClick={() => setActiveTab("tab1")}
        >Trending Now</button></div>

<div  className="tempp"><button id="stat-btn-2"  className={activeTab === "tab2" ? "active" : "notActiveMe"} 
          onClick={() => setActiveTab("tab2")}
        >Top Pick</button></div>

<div className="tempp"><button  id="stat-btn-3" className={activeTab === "tab3" ? "active" : "notActiveMe"} 
          onClick={() => setActiveTab("tab3")}
        >Forever Shine</button></div>
      </div>
...
<div className=' homeProductCat-Grid'>
{
data1.map((value)=>{
return(
