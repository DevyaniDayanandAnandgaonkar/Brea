...
const AboutUs = () => {
    ...
    return (
       ...
       <div className='BlogBanner'> <img src="./AboutUs.jpeg" alt="" /></div>
              <div className='BlogTecx'><h2>About Us</h2>
                   <p><span ><Link to ="/" id="Home-Link">Home / </Link></span> 
                   <span id="active-texc"><Link to ="/AboutUs" id="HomeNot-Link">About Us </Link> </span></p>
                   </div>
