...
const Terms_conditions = () => {
    return (
        ...
        <p>This website is operated by BREA. Throughout the site, the terms “we”, “us” and “our” refer to BREA. BREA offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p><br />
        ...
        <p>Our store is hosted on WordPress. They provide us with the online e-commerce platform that allows us to sell our products and services to you.</p><br /><br />

        <h4>SECTION 1 – ONLINE STORE TERMS</h4><br />

        <p>By agreeing to these Terms of Service, you represent that you are at least the age of majority in your state or province of residence, or that you are the age of majority in your state or province of residence and you have given us your consent to allow any of your minor dependents to use this site.</p><br />
        ...
        <h4>SECTION 2 – GENERAL CONDITIONS</h4><br />
        ...
        <h4>SECTION 3 – ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h4><br />
        ...
        <h4>SECTION 4 – MODIFICATIONS TO THE SERVICE AND PRICES</h4><br />
        ...
        <h4>SECTION 5 – PRODUCTS OR SERVICES (if applicable)</h4><br />

        <p>Certain products or services may be available exclusively online through the website. These products or services may have limited quantities and are subject to return or exchange only according to our Return Policy.</p><br />

        <p>We have made every effort to display as accurately as possible the colours and images of our products that appear at the store. We cannot guarantee that your computer monitor’s display of any colour will be accurate.</p><br />

        <p>We reserve the right, but are not obligated, to limit the sales of our products or Services to any person, geographic region or jurisdiction. We may exercise this right on a case-by-case basis.</p><br />
